  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
</svg> <div style="color:black"> 운영중인 상담방</div>
            </button>
          </h2>
          <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingSeven">
            <div class="accordion-body">
              <div  class="contents-group" v-for="(c,idx) in counselor.data.groups"
            :key="idx"
            :c="c">
              -{{c.title}}
            <router-link :to="{name:'groupDetail', params: {groupId:c.id}}">
            <button class="group-enter-btn" id="group-enter-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
