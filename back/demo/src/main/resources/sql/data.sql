...
-- 3
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2021-11-28', 'ddemaine2@tumblr.com', 'FEMALE', 'test3', 'test3', '010-4447-6503', 'basic', 'basic.png', 3000, 'test3', 'refresh Token', 'USER');
-- 4
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2021-10-17', 'cbastian3@themeforest.net', 'MALE', 'test4', 'test4', '010-1414-9459', 'basic', 'basic.png', 4000, 'test4', 'refresh Token', 'USER');
-- 5
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2021-11-10', 'ctrue4@mac.com', 'FEMALE', 'test5', 'test5', '010-3935-3593', 'basic', 'basic.png', 5000, 'test5', 'refresh Token', 'USER');
-- 6
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2022-05-28', 'bcowherd5@tuttocitta.it', 'MALE', 'test6', 'test6', '010-5483-5633', 'basic', 'basic.png', 6000, 'test6', 'refresh Token', 'USER');
-- 7
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2021-08-19', 'wphette6@imageshack.us', 'FEMALE', 'test7', 'test7', '010-2761-5915', 'basic', 'basic.png', 7000, 'test7', 'refresh Token', 'USER');
-- 8
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
values (now(), now(), '2021-12-05', 'gcasseldine7@cocolog-nifty.com', 'FEMALE', 'test8', 'test8', '010-4411-8045', 'basic', 'basic.png', 8000, 'test8', 'refresh Token', 'USER');
-- 9
insert into USER (created_at, updated_at, birth, email, gender, id, nick_name, phone, file_name, real_file_name, points, pw, refresh_token, type)
...
values (now(), now(), '공부는 왜 이렇게 하기 싫은 걸까요...나이는 먹어가는데 의욕은 더 떨어지네요.', now(), 0, '취업 준비중입니다...', 1);
-- 2
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '매일 아침에 일어날때마다 기분이 너무 안좋아요 ㅠㅠ...', now(), 0, '살려주세요', 1);
-- 3
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '취준이 길어지니까 자꾸 안좋은 생각만 드는거 같아요...', now(), 0, '힘들어요...', 1);
-- 4
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '10년째 취업준비중입니다... 끝이 안보여요...', now(), 0, '취업이 이렇게 힘든건가요', 2);
-- 5
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '친구들은 다들 직장다니고 결혼도하고 잘나가는데 저만 취준생이에요 ㅠ...', now(), 0, '우울해요',  2);
-- 6
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '서류탈락만 300번입니다. 저는 면접 볼 가치도 없다는 걸까요...', now(), 0, '제가 할 수 있을까요?', 3);
-- 7
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '다른 취준생들은 친구들끼리 가끔 만나서 술을 마시기도 하고 서로 힘이 되는거같은데 전 그럴 친구가 없어요 ㅠ 외롭습니다 ㅠㅠ', now(), 0, '털어 놓을 곳이 없어요.',  4);
-- 8
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
values (now(), now(), '여기서 상담 받으면 좀 괜찮아질까요??', now(), 0, '알려주세요',  5);
-- 9
insert into board (created_at, updated_at, contents, date, hit_cnt, title, id)
...
--> text_diary
-- 1
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '오늘은 너무 힘들었다. 서류에서 불합격만 몇번인지 모르겠다. 얼마전 지원했던 곳 10곳 전부 서류불합이다 ㅠㅠ', 10, 8, 99.93, 0.06, 99.93, 0.01, 'negative', '우울하다', 2022, 1);
-- 2
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '이젠 진짜 모르겠다 언제까지 이렇게 해야하는지 ㅠㅠ 취업은 언제쯤 할 수 있을런지 ㅠㅠ 힘들고 지겹다.', 11, 8, 87.58, 12.4, 87.58, 0.03, 'negative', '지겹다', 2022, 1);
-- 3
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '오늘은 힘들지만 그래도 기분이 나쁘지않아서 좀 더 열심히 한 것 같아 뿌듯하다! 이렇게 하다보면 좋은 날도 있지 않을까?', 12, 8, 0.01, 0.04, 99.96, 99.96, 'positive', '그래도 다시 해보자!', 2022, 1);
-- 4
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '서류 합격은 누가 하는지 모르겠다. 왜 항상 나만 불합격인거지 ㅠㅠ 옆에 친구들은 잘만 합격하던데 또 우울하다.', 13, 8, 94.32, 5.67, 0.01, 94.32, 'negative','또 불합격...', 2022, 1);
-- 5
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '오늘 점심에 족발 사먹었는데 맛있었다. 잠시나마 취준생이란걸 잊을 수 있었는듯하다. 가끔 맛있는걸 먹으러 가야겠다. 기분이 좋아졌다.', 14, 8, 0.03, 14.07, 85.9, 85.9, 'positive', '오늘은 밥이 맛있네', 2022, 1);
-- 6
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '드디어 서류합격을 했다!! 이게 얼마만인지 모르겠다. 제일 가고싶은 회사는 아니지만 그래도 이정도면 감지덕지다. 면접준비 열심히 해봐야지! 화이팅!', 15, 8, 0.11, 5.59, 94.3, 94.3, 'positive', '이게 맞지', 2022, 1);
-- 7
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '면접을 준비하려고 면접스터디원을 구했다. 다들 의욕이 넘치고 스펙이 좋아서 좀 주눅들긴하지만 그래도 까보기전까진 모르니까 최선을 다해보자!', 16, 7, 0.03, 14.31, 85.66, 85.66, 'positive', '면접스터디!', 2022, 1);
-- 8
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '스터디원중 한분이 왜 자꾸 술을 마시자고 하는지 모르겠다. 면접준비하러 모인거지 놀러온게 아닌데... 스터디가 노는 분위기로 가면 곤란한데 걱정이 많다. 면접은 얼마 안남고 초조하다...', 17, 7, 99.95, 0.04, 0.01, 99.95, 'negative', '스터디원이 좀 이상하다', 2022, 1);
-- 9
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '면접을 보고왔다...정말 아무말도 못 했다. 예상질문을 철저히 준비해갔다고 생각했는데 막상 면접장에 가니 아무것도 생각이 나지 않았다..ㅠㅠ 면접장 나오자마자 펑펑 울었다. 망한 것 같아...', 18, 7, 95.47, 4.49, 0.03, 95.47, 'negative', '면접...', 2022, 1);
-- 10
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '아침에 일어나니 그래도 기분이 괜찮았다. 지나간 면접은 지나가게 두고 또 힘내서 열심히 해봐야지! 면접이 떨어지면 또 지원하고 또 지원하고 하다보면 합격할 수 있을거야!', 19, 7, 0.48, 7.23, 92.29, 92.29, 'positive', '다시 열심히 힘내보자!', 2022, 1);
-- 11
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '오늘따라 왜이렇게 공부가 손에 안잡히는지 모르겠다. 아침부터 지금까지 아무것도 못 했다. 우울해서 눈물이 나온다. 힘들다 힘들어', 11, 8, 99.97, 0.02, 0.01, 99.97, 'negative', '힘들다', 2022, 2);
-- 12
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '어제 늦게 자서 그런지 아침에 알람을 못 듣고 자버렸다. ㅠㅠ 학원에 결국 지각했다. 하루종일 정신이 없는 하루였다. 아침부터 지각해서 그런지 일이 자꾸 꼬이는 기분이 들었다. 힘든 하루 였다.', 12, 8, 95.99, 4.0, 0.01, 95.99, 'negative', '알람을 못 들었다 ㅠㅠ', 2022, 2);
-- 13
insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
values (now(), now(), '난 왜이렇게 일이 잘 안풀릴까? 오늘도 또 지각을 해버렸다. 왜 매번 알람을 못 듣고 자버리는걸까? 잠자기전에 인스타그램보는걸 그만해야겠다.', 13, 8, 95.96, 4.04, 0.0, 95.96, 'negative', '힘든 하루였다', 2022, 2);
-- 14
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '오늘은 일찍 일어났다. 학원에 일찍 도착하니 기분이 아주 상쾌했다. 역시 이래서 아침형인간이 좋다는거구나 ㅎㅎ 그래서 그런지 공부도 잘되고 뿌듯한 하루였다.', 14, 8, null, null, null, null, null, '오늘은 기분이 좋다', 2022, 2);
-- 15
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '얼마전에 지원했던 회사에서 최종불합격 통보를 받았다. ㅡㅡ... 무조건 붙을거라 생각하고 붙은다음에 다른회사도 지원해볼 생각 이었는데 계획이 수포로 돌아갔다. 짜증난다.', 15, 8, null, null, null, null, null, '아 이건 좀 아닌데', 2022, 2);
-- 16
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '마땅한 스터디가 없어서 이리저리 찾다가 취준생커뮤니티에서 스터디를 구했다. 시작이 좋다. 열심히 스터디참여해야지! 일단 스터디원들이랑 어떤식으로 진행할지 회의를 해봐야겠다. ', 10, 8, null, null, null, null, null, '스터디를 드디어 구했다!', 2022, 3);
-- 17
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '어제 구했던 스터디원들과 첫 스터디를 가졌다. 다들 우울해보여서 나도 우울해졌다. 어딜가나 항상 사람이 중요하다더니 정말이다. 잘 할 수 있을까? 걱정이 앞선다...', 11, 8, null, null, null, null, null, '스터디는 힘들다', 2022, 3);
-- 18
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '스터디원들과 오늘 다툼이 좀 있었다. 다들 의욕이 없어서 회의를 하는내내 아무도 의견을 내질 않는다... 그래서 내가 한마디 했더니 어떤사람이 굉장히 기분나쁘게 비꼬듯이 말했다. 크게 싸울뻔 했지만 참았다... 그냥 나가야겠다...', 12, 8, null, null, null, null, null, '그냥 나갈래', 2022, 3);
-- 19
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '스터디를 결국 탈퇴했다. 오늘 아침에 단톡방에 나가겠다고 얘기하고 나와버렸다. 후... 힘들겠지만 다시 스터디원을 구해봐야겠다. 한번 해봤으니 두번은 쉽겠지? 다시 하면 된다! 열심히 해보자!', 13, 8, null, null, null, null, null, '다시 시작', 2022, 3);
-- 20
--insert into text_diary (created_at, updated_at, contents, day, month, negative, neutral, percentage, positive, sentiment, title, year, user_id)
--values (now(), now(), '와 정말 생각지도 못한 회사에서 합격문자를 받았다. 너무 기뻐서 부모님한테도 알리고 친구들한테도 자랑했다. 근데 몇시간뒤에 합격이 취소되었다...잘못 보낸거라고 한다... 자랑 다했는데... 이건좀 아니지... 장난하나...우울해졌다.  ', 18, 7, null, null, null, null, null, '이건 좀 아니지...', 2022, 4);